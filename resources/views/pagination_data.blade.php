                ...
                <div class="product-img">
                    ...
                    <div class="button-head">
                        <div class="product-action">
                            ...
                            <a title="Wishlist" href="{{ route('add_wishlist',[$row->id]) }}"><i class=" ti-heart ">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="quickview-content">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="button plus">
                                                <button type="button" class="btn btn-primary btn-number" data-type="plus" data-field="quant[1]"><i class="ti-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                        <!--/ End Input Order -->
                                    ...
                                    <div class="add-to-cart">
                                        ...
                                        <a href="{{ route('add_wishlist',[$row->id]) }}" class="btn min"><i class="ti-heart"></i></a>
                                    </div>                                
                                </div>
                            </div>
                        </div>
