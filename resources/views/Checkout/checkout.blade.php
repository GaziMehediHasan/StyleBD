    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge badge-secondary badge-pill">{{ Cart::instance('cart')->count() }}</span>
            </h4>
            <ul class="list-group mb-3">
                @foreach(Cart::instance('cart')->content() as $row)
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <h6 class="my-0">{{ $row->name }}</h4>
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_mobile" class="form-control" id="mobile" placeholder="e.g. 01711xxxxxx"
                               value="" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="customer_email" class="form-control" id="email"
                           placeholder="e.g. you@example.com" value="" required>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name = "customer_address" class="form-control" id="address"
                     placeholder="e.g. 93 B, New Eskaton Road"value="" required>
                    <div class="invalid-feedback">
