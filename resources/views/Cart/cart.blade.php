            						...
            						<tr>
            							...
            							<td class="qty" data-title="Qty"><!-- Input Order -->
            								<div class="input-group">
                                                <a class="ti-minus button minus" href="{{ url('/decrease/qty/'.$row->rowId) }}"></a>
            									<input type="text" class="input-number" value="{{$row->qty}}" data-max="100" pattern="[0-9]*">
                                                <a class="ti-plus button plus" href="{{ url('/increase/qty/'.$row->rowId) }}"></a>
            								</div>
            								<!--/ End Input Order -->
            							</td>
            							<td class="total-amount" data-title="Total"><span>{{ $row->subtotal }}</span></td>
            							<td class="action" data-title="Remove"><a href="{{ route('remove_cart',[$row->rowId]) }}">
            						...
            						<div class="col-lg-4 col-md-7 col-12">
            							<div class="right">
            								<ul>
            									...
            									<li>Vat(15%)<span>{{Cart::instance('cart')->tax()}}</span></li>
            									<li class="last">Cart Subtotal<span>{{Cart::instance('cart')->total()}}</span></li>
            								</ul>
            								<div class="button5">
