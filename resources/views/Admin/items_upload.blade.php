    ...
    <div class="limiter">
      <div class="container-upload">
        <div class="wrap-upload">
            <form class="form1" method ="post" action="{{ route('StoreItem') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="wrap-input100 validate-input">
                    <input ID="TextBox1" class="input100" name="Name" placeholder="Name">
                </div>
                @error('Name')
                ...
                <div class="wrap-input100 validate-input" >
                    <input ID="TextBox1" class="input100" name="Price" placeholder="Price">
                </div>
                @error('Price')
                  <div class="alert-danger">{{ $message }}</div>
                @enderror
                ...
                <div class="wrap-input100 validate-input">
                    <input ID="TextBox1" class="input100" name="Discount" placeholder="Discount">
                </div>
                @error('Discount')
                  <div class="alert-danger">{{ $message }}</div>
                @enderror
                ...
                <div class="wrap-input100 validate-input">
                    <input ID="TextBox1" class="input100" name="Ratings" placeholder="Ratings">
                </div>
                @error('Ratings')
                  <div class="alert-danger">{{ $message }}</div>
                @enderror
